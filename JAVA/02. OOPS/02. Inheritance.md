---
tags: [java, oops, inheritance, pillar]
---
...
<svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
  ...
  <line x1="50" y1="55" x2="350" y2="55" stroke="#2E7D32" stroke-width="1" />
  <text x="60" y="75" font-size="12" fill="#1B5E20">• name: String</text>
  <text x="60" y="95" font-size="12" fill="#1B5E20">
    • eat(), sleep(), displayInfo()
  </text>
  ...
  />
  <text x="210" y="145" font-size="12" fill="#2E7D32" font-style="italic">
    extends
  </text>
  ...
  <line x1="50" y1="195" x2="350" y2="195" stroke="#E65100" stroke-width="1" />
  <text x="60" y="215" font-size="12" fill="#BF360C">
    Inherited: name, eat(), sleep(), displayInfo()
  </text>
  <text x="60" y="235" font-size="12" fill="#BF360C">• breed: String</text>
  <text x="60" y="255" font-size="12" fill="#BF360C">
    • bark() [New method]
  </text>
</svg>
```

### Visual Diagram: Hierarchical Inheritance
...
<svg viewBox="0 0 600 350" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Lines down -->
  <line x1="300" y1="80" x2="150" y2="120" stroke="#2E7D32" stroke-width="2" />
  <line x1="300" y1="80" x2="300" y2="120" stroke="#2E7D32" stroke-width="2" />
  <line x1="300" y1="80" x2="450" y2="120" stroke="#2E7D32" stroke-width="2" />
  ...
  <text x="300" y="275" font-size="11" text-anchor="middle" fill="#666">
    (One parent → Multiple children)
  </text>
  <text x="300" y="295" font-size="11" text-anchor="middle" fill="#666">
    Each child inherits from Animal
  </text>
  <text x="300" y="315" font-size="11" text-anchor="middle" fill="#666">
    but has its own unique methods
  </text>
</svg>
```
...
> [!note] **Parent Class (Superclass)**
> The class being inherited from. Contains common code and behavior.

> [!note] **Child Class (Subclass)**
> The class that inherits from the parent. Reuses parent code and adds its own.

> [!note] **`extends` Keyword**
> Used to indicate that a class inherits from another: `class Dog extends Animal`

> [!note] **Constructor Chaining**
> When a child class calls the parent constructor using `super()`. Ensures parent initialization happens first.

> [!note] **Method Overriding**
> When a child class provides its own implementation of a parent method. Enables polymorphism.
